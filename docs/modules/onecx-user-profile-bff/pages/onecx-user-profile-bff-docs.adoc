...
%prod.quarkus.rest-client.onecx_userprofile_internal_openapi_yaml.providers=io.quarkus.oidc.client.reactive.filter.OidcClientRequestReactiveFilter
...
%prod.quarkus.rest-client.onecx_image_internal_openapi_yaml.providers=io.quarkus.oidc.client.reactive.filter.OidcClientRequestReactiveFilter
----
====
